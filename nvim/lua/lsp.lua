...
-- setup cmdline configuration for search commands (/)
-- cmp.setup.cmdline('/', {
--     mapping = cmp.mapping.preset.cmdline({
--         -- the snippets below are adapted from the code of nvim-cmp itself
--         -- https://github.com/hrsh7th/nvim-cmp/blob/f51dc68e1bb170fc49c2d7e13eb45e5ec83f5ee9/lua/cmp/config/mapping.lua#L69-L88
--         ["<C-j>"] = {
--             c = function(fallback)
--                 local cmp = require('cmp')
--                 if cmp.visible() then
...
-- -- setup cmdline configuration for normal commands (:)
-- cmp.setup.cmdline(':', {
--     mapping = cmp.mapping.preset.cmdline({
--         -- the snippets below are adapted from the code of nvim-cmp itself
--         -- https://github.com/hrsh7th/nvim-cmp/blob/f51dc68e1bb170fc49c2d7e13eb45e5ec83f5ee9/lua/cmp/config/mapping.lua#L69-L88
